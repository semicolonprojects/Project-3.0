...
<div className='relative mx-14'>
    ...
    <div className='relative mx-1 my-16'>
      ...
      <div className="flex items-center">
        ...
        <h1 className='text-4xl font-bold'>Reglue Service</h1>
        <div className='pt-2'>
            <p className='text-xl font-bold'>Rp. 25.000 - Rp.80.000</p>
          </div>
        </div>
      <div className='my-5'>
         <div className='grid grid-flow-row'>
          <p>Proses pengeleman ulang sepatu, dengan estimasi yang disesuaikan oleh 
            tingkat kesulitan dan dimensi bagian yang akan di lakukan pengeleman ulang. 
            Estimasi pengerjaan dari proses ini <br /> kurang lebih 4 sampai 7 hari kerja.
          </p>
         </div>
