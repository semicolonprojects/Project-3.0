      ...
      <div className="relative mx-14">
        <div className="grid grid-cols-2">
          <div className="max-w-md w-full h-full ">
            <img src="/img/2.png" alt="..." className="h-[560px] w-full" />
          </div>
          ...
          <div className="relative mx-1 my-16">
            ...
            <div className="my-5">
              <div className="grid grid-flow-row">
                <p>
                  Proses pengeleman ulang sepatu, dengan estimasi yang
                  disesuaikan oleh tingkat kesulitan dan dimensi bagian yang
                  akan di lakukan pengeleman ulang. Estimasi pengerjaan dari
                  proses ini <br /> kurang lebih 4 sampai 7 hari kerja.
                </p>
              </div>
