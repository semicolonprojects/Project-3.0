        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[#E1EAF3] flex items-center justify-center">
          <div className="flex justify-center md:px-32 md:justify-end md:w-auto py-5 w-screen">
            <div className="relative max-w-max p-5 flex-col">
              <p className="text-[#FFB62B] py-1 font-bold text-xl desktop:text-5xl text-center">
                Status
              </p>
              <p className="text-blue-400 py-1 font-normal text-xl desktop:text-2xl text-center">
                Cek Status Pesanan Kamu Disini !
              </p>
              <div className="w-full desktop:w-full h-auto grid grid-flow-row gap-6">
                <div className="relative py-1">
                  <div className="p-4 bg-[#E1EAF3] hover:shadow-2xl rounded-xl w-[600px]">
                    ...
                    <input
                      ...
                      className=" text-lg md:text-2xl placeholder:text-center  bg-transparent border-b focus:border-blue-400 rounded-md  w-full ps-10 p-1.5 outline-none  text-blue-500"
                      value={inputValue}
